#language: pt
Funcionalidade: Realizacao de login de usuario

@login
  Cenario: Verificar se o site Automation Pratice esta efetuando o login com sucesso
    ...
    E digito a senha <senha> para senha
    E clico em entrar
...
| "conta.teste.automacao@hotmail.com" | "Automacao@"   |
| 																	  | 							 |
